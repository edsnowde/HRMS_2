...
export const AIChatBubble = ({ message = "Hello! I'm your AI assistant. How can I help you today?", timestamp = new Date(), suggestions = [], onSuggestionClick }: AIChatBubbleProps) => {
